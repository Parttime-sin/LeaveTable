 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZA(t){En(new on("platform-logger",e=>new dA(e),"PRIVATE")),En(new on("heartbeat",e=>new YA(e),"PRIVATE")),Wt(Yh,zg,t),Wt(Yh,zg,"esm2017"),Wt("fire-js","")}ZA("");var ek="firebase",tk="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Wt(ek,tk,"app");var Gg=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mt{constructor(e){this.fields=e,e.sort(Qe.comparator)}static empty(){return new Mt([])}unionWith(e){let n=new Xe(Qe.comparator);for(const r of this.fields)n=n.add(r);for(const r of e)n=n.add(r);return new Mt(n.toArray())}covers(e){for(const n of this.fields)if(n.isPrefixOf(e))return!0;return!1}isEqual(e){return ei(this.fields,e.fields,(n,r)=>n.isEqual(r))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hI="installations",$2="installations-internal",B2=t=>{const e=t.getProvider("app").getImmediate(),n=U2(e),r=us(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},z2=t=>{const e=t.getProvider("app").getImmediate(),n=us(e,hI).getImmediate();return{getId:()=>L2(n),getToken:s=>j2(n,s)}};function q2(){En(new on(hI,B2,"PUBLIC")),En(new on($2,z2,"PRIVATE"))}q2();Wt(GE,vp);Wt(GE,vp,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
